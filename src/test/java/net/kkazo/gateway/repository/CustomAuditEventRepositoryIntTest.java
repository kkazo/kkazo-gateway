package net.kkazo.gateway.repository;

import net.kkazo.gateway.GatewayApp;
import net.kkazo.gateway.config.Constants;
import net.kkazo.gateway.config.audit.AuditEventConverter;
import net.kkazo.gateway.domain.PersistentAuditEvent;
...
import static net.kkazo.gateway.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
